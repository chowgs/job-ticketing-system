...
class CreativeFormController extends Controller
{
    // STORE DATA BUTTON
    public function saveData(Request $request)
    {
        ...
        $imagePath = 'images/creative-head.png';
        ...
        $pdf->SetTitle('creative-works-form');
        $pdf->SetSubject('Creative Works Form');
        $pdf->SetKeywords('Form, Creative Works, TCPDF');
        ...
        // Content
        $html = view('job-order-form.creative-pdf-form', [
            'imagePath' => $imagePath,
