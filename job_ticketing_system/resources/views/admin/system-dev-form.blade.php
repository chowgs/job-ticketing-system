...
<head>
    ...
    <title>IT Personnel: System Development Form</title>
    <!-- Bootstrap CSS -->
...
<body>
    ...
    <div class="form-container">
        <!-- Back Button -->
        <form action="{{ route('save-data-sys') }}" method="POST" target="pdf_frame" class="form-item">
            @csrf
